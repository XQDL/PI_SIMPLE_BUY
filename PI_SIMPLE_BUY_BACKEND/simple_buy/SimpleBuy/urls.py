...
urlpatterns = [
    ...
    path('inicio-comprador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-administrador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-comprador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-administrador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-comprador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-administrador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/<int:of_id>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-comprador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/<int:of_id>/', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-administrador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/<int:of_id>/salvar', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('inicio-comprador/<str:nomeUsuario>/integrar-nota-fiscal/<int:fornecedor_id>/<int:num_nf>/<int:item_id>/<int:of_id>/salvar', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
