...
urlpatterns = [
    ...
    path('compradores-cadastrados', views.compradores_cadastrados, name='compradores_cadastrados'),
    ...
    path('inicio-comprador', views.inicio_comprador, name='inicio_comprador'),
    path('integrar-nota-fiscal', views.integrar_nota_fiscal, name='integrar_nota_fiscal'),
    path('itens-pendentes-cotacao', views.itens_pendentes_cotacao, name='itens_pendentes_cotacao'),
