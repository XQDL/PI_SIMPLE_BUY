...
urlpatterns = [
    ...
    path('inicio-administrador/<str:nomeUsuario>/aprovacoes-pendentes', views.aprovacoes_pendentes, name='aprovacoes_pendentes'),
    path('inicio-administrador/<str:nomeUsuario>/aprovacoes-pendentes/<str:res>/<int:of_id>', views.aprovacoes_pendentes, name='aprovacoes_pendentes'),
    ...
    path('inicio-administrador/<str:nomeUsuario>/historico-compras', views.historico_compras, name='historico_compras'),
    path('inicio-comprador/<str:nomeUsuario>/historico-compras', views.historico_compras, name='historico_compras'),
    path('inicio-administrador/<str:nomeUsuario>/info-of/<int:of_id>', views.info_of, name='info_of'),
    path('inicio-comprador/<str:nomeUsuario>/info-of/<int:of_id>', views.info_of, name='info_of'),
    ...
    path('inicio-comprador/<str:nomeUsuario>/ofs-pendentes/<int:of_id>', views.ofs_pendentes, name='ofs_pendentes'),
